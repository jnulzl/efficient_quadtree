...
# retrieve and store the bin string
ei_set_build_string()
...
# Overwrite default DartConfiguration.tcl such that ctest can bin our unit tests.
# Recall that our unit tests are not in the "all" target, so we have to explicitely ask ctest to bin our custom 'buildtests' target.
# At this stage, we can also add custom flags to the bin tool through the user defined EIGEN_TEST_BUILD_FLAGS variable.
